...
export default function CompanySettings() {
  ...
  const [trainerNotif, setTrainerNotif] = useState(settings.trainerNotif !== false);
  ...
  return (
    <PremiumPage>
      ...
      <PageHeader title="Company Settings" emoji="🏢" subtitle="Configure your company preferences and security." />
      ...
      <SectionCard icon={<Bell size={22} />} iconBg="rgba(255,92,138,0.1)" iconColor={P.red} title="Notification Preferences" desc="Choose how and when you receive updates">
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <SettingRow title="Trainer Assignment Alerts" desc="Get notified when admin assigns a trainer to your company">
            <Toggle value={trainerNotif} onChange={() => handleSettingChange('trainerNotif', !trainerNotif, setTrainerNotif)} />
          </SettingRow>
          <SettingRow title="Course & Certificate Updates" desc="Alerts for new courses, completions, and certificate issuance">
      ...
      <SectionCard icon={<Globe size={22} />} iconBg="rgba(34,197,94,0.1)" iconColor={P.green} title="Data & Privacy" desc="Manage your data and account">
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
          <SettingRow title="Profile Visibility" desc="Allow admin and other companies to see your company profile">
            <Toggle value={profileVisibility} onChange={() => handleSettingChange('profileVisibility', !profileVisibility, setProfileVisibility)} />
          </SettingRow>
          <SettingRow title="Activity Logging" desc="Allow the platform to log your activity for analytics">
      ...
      <SectionCard icon={<HelpCircle size={22} />} iconBg="rgba(79,140,255,0.1)" iconColor={P.blue} title="Help & Support" desc="Get assistance or report issues">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
          {[
            { title: 'Documentation', desc: 'Browse platform guides and FAQs', icon: <BookOpen size={20} />, color: P.primary },
