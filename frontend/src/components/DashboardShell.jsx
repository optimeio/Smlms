...
const roleNavigation = {
  Student: [
    ...
    { key: 'skills', label: 'Skill Progression', path: '/app/a/skills' },
    { key: 'courses', label: 'My Courses', path: '/app/a/courses' },
    { key: 'projects', label: 'Projects & Portfolio', path: '/app/a/projects' },
    { key: 'attendance', label: 'Attendance & Discipline', path: '/app/a/attendance' },
    { key: 'passport', label: 'Skill Passport', path: '/app/a/passport' },
    { key: 'ai-assistant', label: 'AI Tutor & Gap Diagnostic', path: '/app/a/ai-assistant' },
    ...
    { key: 'jobs', label: 'Job Offers & Internships', path: '/app/a/jobs' },
  ...
  Trainer: [
    ...
    { key: 'attendance', label: 'Attendance Marking', path: '/app/b/attendance' },
    { key: 'evaluations', label: 'Project Evaluations', path: '/app/b/evaluations' },
    { key: 'ai-assistant', label: 'AI Quiz & Content Generator', path: '/app/b/ai-assistant' },
  ...
  'Industry Trainer': [
    { key: 'dashboard', label: 'Dashboard', path: '/app/b/dashboard' },
    { key: 'courses', label: 'Industry Specializations', path: '/app/b/courses' },
    { key: 'evaluations', label: 'Project & Lab Evaluations', path: '/app/b/evaluations' },
    { key: 'live', label: 'Live Masterclasses', path: '/app/b/live' },
    { key: 'attendance', label: 'Attendance', path: '/app/b/attendance' },
    { key: 'materials', label: 'Industrial Materials', path: '/app/b/materials' },
    { key: 'notifications', label: 'Notifications', path: '/app/b/notifications' },
    { key: 'profile', label: 'Profile', path: '/app/b/profile' },
    { key: 'settings', label: 'Settings', path: '/app/b/settings' },
    { key: 'logout', label: 'Logout', action: 'logout' },
  ...
  Company: [
    ...
    { key: 'internships', label: 'Internship Postings', path: '/app/c/internships' },
    { key: 'evaluations', label: 'Supervisor Evaluations', path: '/app/c/evaluations' },
    { key: 'courses', label: 'Sponsored Courses', path: '/app/c/courses' },
  ...
  'Industry Supervisor': [
    { key: 'dashboard', label: 'Dashboard', path: '/app/c/dashboard' },
    { key: 'evaluations', label: 'Intern Weekly Evaluations', path: '/app/c/evaluations' },
    { key: 'internships', label: 'Assigned Interns', path: '/app/c/internships' },
    { key: 'notifications', label: 'Notifications', path: '/app/c/notifications' },
    { key: 'profile', label: 'Profile', path: '/app/c/profile' },
    { key: 'settings', label: 'Settings', path: '/app/c/settings' },
    { key: 'logout', label: 'Logout', action: 'logout' },
  ...
  'Training Institute': [
    { key: 'dashboard', label: 'Institute Dashboard', path: '/app/e/dashboard' },
    { key: 'batches', label: 'Batch Management', path: '/app/e/batches' },
    { key: 'trainers', label: 'Trainers Roster', path: '/app/e/trainers' },
    { key: 'students', label: 'Students Roster', path: '/app/e/students' },
    { key: 'labs', label: 'Lab & Equipment', path: '/app/e/labs' },
    { key: 'attendance', label: 'Attendance Reports', path: '/app/e/attendance' },
    { key: 'notifications', label: 'Notifications', path: '/app/e/notifications' },
    { key: 'profile', label: 'Profile', path: '/app/e/profile' },
    { key: 'settings', label: 'Settings', path: '/app/e/settings' },
    { key: 'logout', label: 'Logout', action: 'logout' },
  ],
  College: [
    { key: 'dashboard', label: 'College Dashboard', path: '/app/f/dashboard' },
    { key: 'departments', label: 'Department Overview', path: '/app/f/departments' },
    { key: 'students', label: 'Student Directory & Skills', path: '/app/f/students' },
    { key: 'attendance', label: 'Attendance & Discipline', path: '/app/f/attendance' },
    { key: 'projects', label: 'Project Submissions', path: '/app/f/projects' },
    { key: 'placement', label: 'Placement Readiness', path: '/app/f/placement' },
    { key: 'notifications', label: 'Notifications', path: '/app/f/notifications' },
    { key: 'profile', label: 'Profile', path: '/app/f/profile' },
    { key: 'settings', label: 'Settings', path: '/app/f/settings' },
    { key: 'logout', label: 'Logout', action: 'logout' },
  ],
  'Placement Officer': [
    { key: 'dashboard', label: 'Placement Dashboard', path: '/app/g/dashboard' },
    { key: 'matching', label: 'Candidate Skill Matching', path: '/app/g/matching' },
    { key: 'interviews', label: 'Interviews & Mock Portal', path: '/app/g/interviews' },
    { key: 'job-offers', label: 'Corporate Job Openings', path: '/app/g/jobs' },
    { key: 'students', label: 'Eligible Candidates', path: '/app/g/students' },
    { key: 'analytics', label: 'Placement Analytics', path: '/app/g/analytics' },
    { key: 'notifications', label: 'Notifications', path: '/app/g/notifications' },
    { key: 'profile', label: 'Profile', path: '/app/g/profile' },
    { key: 'settings', label: 'Settings', path: '/app/g/settings' },
    { key: 'logout', label: 'Logout', action: 'logout' },
  ],
  Parent: [
    { key: 'dashboard', label: 'Ward Dashboard', path: '/app/h/dashboard' },
    { key: 'attendance', label: 'Attendance & Punctuality', path: '/app/h/attendance' },
    { key: 'passport', label: 'Skill Passport & Badges', path: '/app/h/passport' },
    { key: 'courses', label: 'Enrolled Courses', path: '/app/h/courses' },
    { key: 'certificates', label: 'Certificates & Awards', path: '/app/h/certificates' },
    { key: 'profile', label: 'Profile', path: '/app/h/profile' },
    { key: 'logout', label: 'Logout', action: 'logout' },
  ],
  'Super Admin': [
    ...
    { key: 'institutes', label: 'Institutes & Colleges', path: '/app/d/spoc' },
    { key: 'job-offers', label: 'Job Offers & Internships', path: '/app/d/job-offers' },
